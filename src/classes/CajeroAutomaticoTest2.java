...
public class CajeroAutomaticoTest2 {
    ...
    public void caso1_testConsultaSaldoInicial() {
        ...
        assertThat(resultado, is("El saldo de la cuenta es 1000"));
    }
    ...
    public void caso2_testDepositoValido() {
        ...
        assertThat(resultado, equalTo("Deposito exitoso"));
    }
    ...
    public void caso3_testRetiroMenorAlSaldo() {
        ...
        assertThat(resultado, containsString("Retiro exitoso"));
    }

    @Test
    public void caso4_testRetiroExactoDelSaldo() {
        Map<String, Object> args = new HashMap<>();
        args.put("monto", 1000.0);
        String resultado = CajeroAutomatico.menu("r", args);
        assertThat(resultado, is("Retiro exitoso"));
    }

    @Test
    public void caso5_testSalirDelSistema() {
        String resultado = CajeroAutomatico.menu("s", new HashMap<>());
        assertThat(resultado, startsWith("Gracias por usar"));
    }
